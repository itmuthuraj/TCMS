						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<view:forEach var="info" items="${courselist}">
										<tr>
											<td>${info.getCourseId() }</td>
											<td>${info.getCourseName()}</td>
											<td>${info.getCourseDescription()}</td>
											<td>${info.getFees()}</td>
											<td><a href='/edit/${info.getCourseId()}'>Edit</a></td>
											<td><a href='/delete/${info.getCourseId()}'>Delete</a></td>
