...
<body>
	<%@include file="Adminnav.jsp"%>	<form action="insertbatch" method="post" style="padding-top: 100px;">
			<div class="form-group">
				<label for="description">Starting Date</label> <input type="text"
					class="form-control" name="batchStartDate" id="batchStartDate"
					placeholder="Enter date (dd/mm/yyyy)">
			</div>
			<div class="form-group">
				<label for="fees">Course</label> <select class="form-control"
					name="courseId" id="courseId" placeholder="Selete the course"><value:forEach
