						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<view:forEach var="info" items="${batchlist}">
										<tr>
											<td>${info.getBatchId() }</td>
											<td>${info.getBatchName()}</td>
											<td>${info.getBatchStartDate()}</td>
											<td>${info.getCourseId()}</td>
											<td><a href='/edit/${info.getBatchId()}'>Edit</a></td>
											<td><a href='/delete/${info.getBatchId()}'>Delete</a></td>
