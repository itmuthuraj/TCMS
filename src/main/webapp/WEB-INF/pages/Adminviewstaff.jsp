...
<body>
	<%@include file="Adminnav.jsp"%>		<div class="container-fluid page-body-wrapper">
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table">
									...
									<view:forEach var="info" items="${stafflist}">
										<tr>
											<td>${info.getStaffId() }</td>
											<td>${info.getStaffName()}</td>
											<td>${info.getMobile()}</td>
											<td>${info.getMailId()}</td>
											<td>${info.getDateOfBirth()}</td>
											<td>${info.getGender()}</td>
											<td>${info.getCourseId()}</td>
											<td><a href='/edit/${info.getStaffId()}'>Edit</a></td>
											<td><a href='/delete/${info.getStaffId()}'>Delete</a></td>
