...
<%@include file="Adminnav.jsp"%>
		...
		<form action="/insertadminstudent" method="get"
			modelAttribute="student" style="padding-top: 100px;"
			class="studentform">
			<div id="firsthalf">
				<div class="form-group">
					<label for="studentname">Student Name</label> <input type="text"
						class="form-control" name="studentName" id="studentName"
						aria-describedby="name" placeholder="Enter Student Name">
				</div>
				<div class="form-group">
					<label for="address">Student Address</label> <input type="text"
						class="form-control" name="studentAddress" id="studentAddress"
						placeholder="Enter Student Address">
				</div>
				<div class="form-group">
					<label for="emailId">Mail Id</label> <input type="email"
						class="form-control" name="mailId" id="mailId"
						placeholder="Enter mail id">
				</div>
				<div class="form-group">
					<label for="mobile">Student Mobile</label> <input type="text"
						class="form-control" name="studentMobile" id="studentMobile"
			...
			<div id="secondhalf">
				...
				<div class="form-group">
					<label for="course">Course</label> <select class="form-control"
						name="courseName" id="courseId" placeholder="Selete the course"><value:forEach
							var="course" items="${courseInfo}">
							<option value="${course.getCourseName()}">${course.getCourseName()}</option>
						</value:forEach></select>
				</div>
				<div class="form-group">
					<label for="studentQualification">Student Qualification</label> <input
						type="text" class="form-control" name="studentQualification"
				...
				<div class="form-group">
					<label for="yearsofpassing">years of passing</label> <input
						type="text" class="form-control" name="yearOfPassing"
						id="staffqualification" placeholder="Enter years of passing ">
				</div>
				<div class="form-group">
					<label for="institution">years of passing</label> <input
