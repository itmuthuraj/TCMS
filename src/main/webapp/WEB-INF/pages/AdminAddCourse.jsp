...
<body>
	<%@include file="Adminnav.jsp"%>
			<form action="/insertadmincourse" method="get" modelAttribute="course"
			...
			<div class="form-group">
				<label for="description">Course Description</label> <input
					type="text" class="form-control" name="courseDescription"
					id="courseDescription" placeholder="Enter Course Description">
			</div>
			<div class="form-group">
				<label for="fees">Course Fees</label> <input type="text"
					class="form-control" name="fees" id="fees"
